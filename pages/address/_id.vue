    ...
    <div class="card section-card">
      ...
      <div class="card-body info-table">
        ...
        <div class="columns">
          ...
          <div class="column info-value monospace">
            ...
            <span v-if="unconfirmed !== '0' && staking !== '0'">
              ({{ unconfirmed | borsh }} BORSH {{ $t('address.unconfirmed') }},
              {{ staking | borsh }} BORSH {{ $t('address.staking') }})
            </span>
        ...
        <div class="columns">
          ...
          <div class="column info-value monospace">{{ totalReceived | borsh }} BORSH</div>
        </div>
        <div class="columns">
          <div class="column info-title">{{ $t('address.total_sent') }}</div>
          <div class="column info-value monospace">{{ totalSent | borsh }} BORSH</div>
        </div>
